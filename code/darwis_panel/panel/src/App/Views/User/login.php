...
<head>
    ...
    <title><?php View::securePrint($_ENV["PRODUCT_TITLE"]); ?> - Login</title>
    ...
    <div class="bg-light min-vh-100 d-flex flex-column align-items-center dark:bg-transparent">
        <div class="container d-flex flex-row flex-grow-1 align-items-center justify-content-center">
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <form action="login" id="login-form" method="POST" autocomplete="off">
                        <div class="card-group d-block d-md-flex row">
                            <div class="card text-white bg-primary col-md-7 p-4 mb-0">
                                <div class="card-body">
                                    <h3><?php View::securePrint($_ENV["PRODUCT_TITLE"]); ?> - Login</h3>
                                    <p class=""></p>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <button form="login-form" class="btn btn-secondary" type="submit"
                                                name="login" value="Login">Login</button>
                                            <?php else : ?>
                                            <button form="login-form" class="g-recaptcha btn btn-secondary"
                                                data-sitekey="<?php \Core\View::securePrint($_ENV['RECAPTCHA_SITE_KEY']); ?>"
                                                data-action='submit' data-callback='submitLogin' name="login"
