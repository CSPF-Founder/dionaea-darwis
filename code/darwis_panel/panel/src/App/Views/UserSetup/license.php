...
<head>
    ...
    <title><?= $_ENV["PRODUCT_TITLE"] ?> Activation</title>
...
<body class=" ">
    ...
    <div class="bg-light min-vh-100 d-flex flex-column align-items-center dark:bg-transparent">
        <div class="container d-flex flex-row flex-grow-1 align-items-center justify-content-center">
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <form action="license" id="license-check-form" method="POST" autocomplete="off">
                        <div class="card-group d-block d-md-flex row">
                            <div class="card text-white bg-primary col-md-7 p-4 mb-0 flex-column py-5 align-items-center justify-content-center">
                                <div class="card-body">
                                    <h2><?php View::securePrint($_ENV["PRODUCT_TITLE"]); ?> - Activation</h2>
                                    <p class=""></p>
                                    ...
                                    <div class="input-group mb-3"><span class="input-group-text">
                                        ...
                                        <input type="text" class="form-control" name="license_key" placeholder="License Key" required>
                                    </div>
                                    <p class=""></p>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <?php if (Captcha::isCaptchaDisabled()) : ?>
                                                <button form="license-check-form" class="btn btn-secondary" type="submit" name="check" value="Check">Activate</button>
                                            <?php else : ?>
                                                <button form="license-check-form" class="g-recaptcha btn btn-secondary" data-sitekey="<?php \Core\View::securePrint($_ENV['RECAPTCHA_SITE_KEY']); ?>" data-action='submit' data-callback='submitLicenseCheck' name="check" value="Check">Activate</button>
                                            <?php endif; ?>
                                        </div>
    ...
    <script>
    function submitLicenseCheck(token) {
        ...
        document.getElementById("license-check-form").submit();
